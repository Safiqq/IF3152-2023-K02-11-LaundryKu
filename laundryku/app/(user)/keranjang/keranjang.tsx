        ...
        <div className="col-span-5 flex flex-col items-center m-16">
          <div className="flex flex-col w-11/12 bg-[#F5F7FF] rounded-2xl drop-shadow-xl sticky top-52">
            <div className="flex flex-col items-center w-full my-12">
              ...
              <div className="mt-6 border-dashed border-2 border-[#6C6C6C] rounded-3xl w-10/12 h-[400px] text-[#6C6C6C] flex flex-col justify-center items-center cursor-pointer">
                <Image
                  src="/upload.svg"
                  width={100}
                  height={100}
